...
const aboutCards = [
  ...
  },
  {
    ...
    richDescription: (
      <>
        Join <span className="text-green-500 font-semibold">50+</span> passionate
      ...
      <div className="pt-24 pb-16 px-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-start">
          ...
          <div>
            ...
            >
              <h1 className="text-2xl md:text-3xl font-bold mb-2">About CSES NITW</h1>
                ...
                <motion.div key={card.title} variants={itemVariants}>
                  <Card className="cyberpunk-glow-card hover-lift relative">
                    ...
                    <CardContent className="p-4 relative z-10 flex items-start gap-4">
                      <card.icon className={`${card.iconColor} h-5 w-5 mt-0.5 flex-shrink-0`} />
                      <div>
          ...
          <div>
            ...
            >
              <h2 className="text-2xl md:text-3xl font-bold mb-2">Our Links</h2>
              <p className="text-base text-slate-400">
            ...
            >
              {links.map((link) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.97 }}
                  className={`group flex flex-col items-center text-center gap-3 w-full p-5 rounded-lg border border-border bg-background/60 backdrop-blur-md transition-all duration-300 shadow-lg ${link.color} hover:shadow-xl`}
                >
                  <div
                    className={`p-3 rounded-lg bg-muted text-slate-400 transition-colors duration-300 ${link.iconColor}`}
                  >
